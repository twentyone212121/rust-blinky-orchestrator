...
1. Zephyr RTOS Baseline (C/C++)
   - Environment Setup: Follow the official Zephyr Geŵing Started Guide to initialize a
     workspace.
   - Build & Flash: Compile the standard simple_blinky sample for the provided NXP board.
   - Demonstration: Successfully Ųash the binary and demonstrate the onboard LED blinking
     as expected.
2. Rust Integration
